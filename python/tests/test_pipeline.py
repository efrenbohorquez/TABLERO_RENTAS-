...
def test_dashboard_data_exists():
    ...
    data_path = os.path.join(os.path.dirname(__file__), '..', '..', 'sat-r-dashboard', 'public', 'data', 'dashboard_data.json')
...
def test_xgboost_forecast_exists():
    ...
    forecast_path = os.path.join(os.path.dirname(__file__), '..', '..', 'sat-r-dashboard', 'public', 'data', 'xgboost_forecast.json')
...
def test_cv_metrics_exists():
    ...
    cv_path = os.path.join(os.path.dirname(__file__), '..', '..', 'sat-r-dashboard', 'public', 'data', 'cv_metrics.json')
